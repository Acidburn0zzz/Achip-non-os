...
//extern void FlashErase(int argc, char *argv[]);
//extern void FlashRead(int argc, char *argv[]);
...
#define SPI_XFER_BEGIN		1	/* Assert CS before transfer */
#define SPI_XFER_END		2	/* Deassert CS after transfer */
...
#if (SP_SPINOR_DMA)
extern u8 dma_buff[CFG_BUFF_MAX];
#endif
